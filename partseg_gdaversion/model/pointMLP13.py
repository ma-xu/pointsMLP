...
class PointMLP13(nn.Module):
    def __init__(self, num_classes=50,points=2048, embed_dim=128, normal_channel=True,
        ...
        super(PointMLP13, self).__init__()
        ...
        self.encoder_stage2 = encoder_stage(anchor_points=points//8, channel=256, reduce=False,
                                            pre_blocks=4, pos_blocks=4, k_neighbor=32)
        self.encoder_stage3 = encoder_stage(anchor_points=points // 16, channel=512, reduce=True,
                                            pre_blocks=4, pos_blocks=4, k_neighbor=32)
        ...
        self.fp3 = PointNetFeaturePropagation(in_channel=512+512, out_channel=512, blocks=4)
