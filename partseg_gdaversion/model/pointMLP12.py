"""
Based on PointMLP9, change configures more blocks.
...
class PointMLP12(nn.Module):
    def __init__(self, num_classes=50,points=2048, embed_dim=128, normal_channel=True,
        ...
        super(PointMLP12, self).__init__()
        ...
        self.encoder_stage1 = encoder_stage(anchor_points=points//4, channel=128, reduce=False,
                                            pre_blocks=3, pos_blocks=5, k_neighbor=32)
        ...
        self.fp4 = PointNetFeaturePropagation(in_channel=(512+512),out_channel=512, blocks=5)
        self.fp3 = PointNetFeaturePropagation(in_channel=512+256, out_channel=512, blocks=5)
        self.fp2 = PointNetFeaturePropagation(in_channel=512 + 256, out_channel=256, blocks=5 )
        self.fp1 = PointNetFeaturePropagation(in_channel=256+128+128, out_channel=256, blocks=5 )
