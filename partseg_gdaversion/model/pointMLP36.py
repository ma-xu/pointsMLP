"""
Based on model31, change add_xyz to 10 dimension.
...
def model36A(num_classes=50, **kwargs) -> PointMLP36:
    return PointMLP36(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
...
def model36B(num_classes=50, **kwargs) -> PointMLP36:
    return PointMLP36(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
                 de_dims=[512, 256, 128, 128], de_blocks=[4,4,4,4],
...
def model36C(num_classes=50, **kwargs) -> PointMLP36:
    return PointMLP36(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model36D(num_classes=50, **kwargs) -> PointMLP36:
    return PointMLP36(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model36E(num_classes=50, **kwargs) -> PointMLP36:
    return PointMLP36(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
