"""
Based on PointMLP9, change configures stage4 1024 channel.
...
class PointMLP11(nn.Module):
    def __init__(self, num_classes=50,points=2048, embed_dim=128, normal_channel=True,
        ...
        super(PointMLP11, self).__init__()
        ...
        self.encoder_stage3 = encoder_stage(anchor_points=points // 16, channel=256, reduce=False,
                                            pre_blocks=4, pos_blocks=4, k_neighbor=32)
        self.encoder_stage4 = encoder_stage(anchor_points=points // 32, channel=512, reduce=False,
                                            pre_blocks=4, pos_blocks=4, k_neighbor=32)

        self.fp4 = PointNetFeaturePropagation(in_channel=(1024+512),out_channel=512, blocks=4)
