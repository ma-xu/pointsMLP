"""
FIx the bug of std calculation: channel-wise
...
class PointMLP39(nn.Module):
    def __init__(self, num_classes=50,points=2048, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        super(PointMLP39, self).__init__()
...
def model39A(num_classes=50, **kwargs) -> PointMLP39:  # 0.85881 0.85861
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model39B(num_classes=50, **kwargs) -> PointMLP39: # 0.85836  0.85864
    return PointMLP39(num_classes=num_classes,points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
...
def model39C(num_classes=50, **kwargs) -> PointMLP39: # 0.85707
    return PointMLP39(num_classes=num_classes,points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
def model39D(num_classes=50, **kwargs) -> PointMLP39: # 0.85560
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
                 de_dims=[512, 256, 128, 128], de_blocks=[4,4,4,4],
...
def model39E(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
...
def model39F(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
# model39G_cos 0.85927 model39G_cos-lr0.001new0.85824 model39G_cos-lr0.0050.859973
# model39G_cos_lr0.01 0.85831 model39G_cos-noinit 0.85904
def model39G(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
...
def model39GA(num_classes=50, **kwargs) -> PointMLP39:  # 0.85825
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model39GB(num_classes=50, **kwargs) -> PointMLP39: # 0.85860
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model39GC(num_classes=50, **kwargs) -> PointMLP39: # 0.86015
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model39G1(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model39G2(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[24, 24, 24, 24], reducers=[4, 4, 4, 4],
...
def model39G3(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
def model39H(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="gelu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
...
def model39I(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
...
def model39X1(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
def model39X2(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=128, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
...
def model39X3(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
...
def model39X4(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=0.125,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
                 de_dims=[512, 256, 128, 128], de_blocks=[4,4,4,4],
...
def model39X5(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="gelu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
def model39X6(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="leakyrelu0.2", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
...
def model39X7(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="leakyrelu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
...
def model39X8(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=128, groups=8, res_expansion=0.25,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
...
def model39K(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 24, 7], reducers=[4, 4, 4, 4],
...
def model39L(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
def model39M(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
def model39N(num_classes=50, **kwargs) -> PointMLP39:
    return PointMLP39(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 24, 6], reducers=[4, 4, 4, 4],
