"""
Based on PointMLP4, change the configs of blocks, 4 to 3
...
class PointMLP7(nn.Module):
    def __init__(self, num_classes=50,points=2048, embed_dim=128, normal_channel=True,
        ...
        self.fp4 = PointNetFeaturePropagation(in_channel=(512+512),out_channel=512, blocks=3)
        self.fp3 = PointNetFeaturePropagation(in_channel=512+256, out_channel=512, blocks=3)
        self.fp2 = PointNetFeaturePropagation(in_channel=512 + 256, out_channel=256, blocks=3 )
        self.fp1 = PointNetFeaturePropagation(in_channel=256+128+128, out_channel=256, blocks=3 )
