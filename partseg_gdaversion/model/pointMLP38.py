"""
Baed on the best result of 3 1
...
class PointMLP38(nn.Module):
    def __init__(self, num_classes=50,points=2048, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        super(PointMLP38, self).__init__()
...
def model38G(num_classes=50, **kwargs) -> PointMLP38:
    return PointMLP38(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
...
def model38G1(num_classes=50, **kwargs) -> PointMLP38:
    return PointMLP38(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model38G2(num_classes=50, **kwargs) -> PointMLP38:
...
def model38G3(num_classes=50, **kwargs) -> PointMLP38:
    return PointMLP38(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=0.25,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
