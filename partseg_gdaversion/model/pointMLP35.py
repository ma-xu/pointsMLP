"""
Based on PointMLP31, add one stage without reducing point number.
...
class PointMLP35(nn.Module):
    def __init__(self, num_classes=50,points=2048, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        super(PointMLP35, self).__init__()
...
def model35G(num_classes=50, **kwargs) -> PointMLP35:
    return PointMLP35(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[1, 2, 2, 2, 2], pre_blocks=[2, 2, 2, 2, 2], pos_blocks=[2, 2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32, 32], reducers=[1, 4, 4, 4, 4],
                 de_dims=[512, 256, 128, 128, 64], de_blocks=[4, 4,4,4,4],
                 gmp_dim=64,cls_dim=64, **kwargs)

def model35A(num_classes=50, **kwargs) -> PointMLP35:
    return PointMLP35(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=0.25,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[1, 2, 2, 2, 2], pre_blocks=[2, 2, 2, 2, 2], pos_blocks=[2, 2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32, 32], reducers=[1, 4, 4, 4, 4],
                 de_dims=[512, 256, 128, 128, 64], de_blocks=[4, 4,4,4,4],
...
def model35B(num_classes=50, **kwargs) -> PointMLP35:
    return PointMLP35(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=1.0,
...
def model35C(num_classes=50, **kwargs) -> PointMLP35:
    return PointMLP35(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=1.0,
...
def model35D(num_classes=50, **kwargs) -> PointMLP35:
    return PointMLP35(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=1.0,
...
def model35E(num_classes=50, **kwargs) -> PointMLP35:
    return PointMLP35(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=1.0,
...
def model35F(num_classes=50, **kwargs) -> PointMLP35:
    return PointMLP35(num_classes=num_classes, points=2048, embed_dim=32, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[1, 2, 2, 2, 2], pre_blocks=[2, 2, 2, 2, 2], pos_blocks=[2, 2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32, 32], reducers=[1, 4, 4, 4, 4],
                 de_dims=[512, 256, 128, 128, 64], de_blocks=[3, 3, 3, 3, 3],
                 gmp_dim=64,cls_dim=64, **kwargs)
