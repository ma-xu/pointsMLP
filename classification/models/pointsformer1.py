...
class Pointsformer1(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64,
        ...
        super(Pointsformer1, self).__init__()
...
def pointsformer1A(num_classes=40, **kwargs) -> Pointsformer1:
...
def pointsformer1B(num_classes=40, **kwargs) -> Pointsformer1:
    return Pointsformer1(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[4,2,2], **kwargs)

def pointsformer1C(num_classes=40, **kwargs) -> Pointsformer1:
    return Pointsformer1(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[4,2,2], **kwargs)

def pointsformer1D(num_classes=40, **kwargs) -> Pointsformer1:
    return Pointsformer1(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[20,20,20],
                 reducers=[4,2,2], **kwargs)

def pointsformer1E(num_classes=40, **kwargs) -> Pointsformer1:
    return Pointsformer1(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[20,20,20],
                 reducers=[4,2,2], **kwargs)

def pointsformer1F(num_classes=40, **kwargs) -> Pointsformer1:
    return Pointsformer1(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[16,16,16],
                 reducers=[4,2,2], **kwargs)

def pointsformer1G(num_classes=40, **kwargs) -> Pointsformer1:
    return Pointsformer1(points=1024, class_num=num_classes, embed_dim=64,
