...
class modelelite(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        super(modelelite, self).__init__()
...
def modeleliteA(num_classes=40, **kwargs) -> modelelite:
    return modelelite(points=1024, class_num=num_classes, embed_dim=64, groups=4, res_expansion=0.25,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)

def modeleliteB(num_classes=40, **kwargs) -> modelelite:
    return modelelite(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=0.25,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)


def modeleliteC(num_classes=40, **kwargs) -> modelelite:
    return modelelite(points=1024, class_num=num_classes, embed_dim=64, groups=8, res_expansion=0.25,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)


def modeleliteD(num_classes=40, **kwargs) -> modelelite:
    return modelelite(points=1024, class_num=num_classes, embed_dim=64, groups=8, res_expansion=0.125,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)


def modeleliteE(num_classes=40, **kwargs) -> modelelite:
    return modelelite(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=0.125,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)


def modeleliteF(num_classes=40, **kwargs) -> modelelite:
    return modelelite(points=1024, class_num=num_classes, embed_dim=64, groups=4, res_expansion=0.25,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
def modeleliteG(num_classes=40, **kwargs) -> modelelite:
    return modelelite(points=1024, class_num=num_classes, embed_dim=64, groups=4, res_expansion=0.25,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
