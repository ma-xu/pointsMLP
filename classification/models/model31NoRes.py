...
class model31NoRes(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        super(model31NoRes, self).__init__()
...
def model31CNoRes(num_classes=40, **kwargs) -> model31NoRes:
    return model31NoRes(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
