"""
Based on model3, only the dropou in FC also configuable.
...
def model3A1(num_classes=40, **kwargs) -> Model3:  # 77.307 neu
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3, dropout=0.1,
                 reducers=[4, 4], **kwargs)

def model3A2(num_classes=40, **kwargs) -> Model3:  # 74.566 neu
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
                 k_neighbors=[32, 32], expansion=2, groups=8,
...
def model3A3(num_classes=40, **kwargs) -> Model3:  # 77.169 neu
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
...
def model3A4(num_classes=40, **kwargs) -> Model3:  # 75.677  neu
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
...
def model3A5(num_classes=40, **kwargs) -> Model3:  # 75.815 neu
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
...
def model3A6(num_classes=40, **kwargs) -> Model3:  # 76.093  neu
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3, dropout=0.1,
                 reducers=[8, 4], **kwargs)
...
def model3A7(num_classes=40, **kwargs) -> Model3:  # 76.301 neu
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
                 k_neighbors=[32, 32], expansion=2, groups=8,
...
def model3A8(num_classes=40, **kwargs) -> Model3:  # 76.579 neu
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=2, dropout=0.1,
                 reducers=[4, 4], **kwargs)

def model3A9(num_classes=40, **kwargs) -> Model3:
    return Model3(points=1024, class_num=num_classes, embed_dim=128, pool="max",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3, dropout=0.1,
                 reducers=[4, 4], **kwargs)


def model3A10(num_classes=40, **kwargs) -> Model3:
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
...
def model3A11(num_classes=40, **kwargs) -> Model3:
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
...
def model3A12(num_classes=40, **kwargs) -> Model3:
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="max",
...
def model3B(num_classes=40, **kwargs) -> Model3:
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="mean",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3,
                 reducers=[4, 4], **kwargs)

def model3C(num_classes=40, **kwargs) -> Model3:
    return Model3(points=1024, class_num=num_classes, embed_dim=64, pool="logsumexp",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3,
                 reducers=[4, 4], **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing model3A1-12")
    for model in [model3A1(),model3A2(),model3A3(),model3A4(),model3A5(),model3A6(),model3A7(),
                  model3A8(),model3A9(),model3A10(),model3A11(),model3A2()]:
        out = model(data)
        print(out.shape)
