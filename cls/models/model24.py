...
def model24A(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=64,
                   pre_blocks=[2, 2, 2], pos_blocks=[2, 2, 2], k_neighbors=[32, 32, 32],
                   reducers=[4, 2, 2], **kwargs)


def model24B(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=32,
                   pre_blocks=[2, 2, 2], pos_blocks=[2, 2, 2], k_neighbors=[32, 32, 32],
                   reducers=[4, 2, 2], **kwargs)


def model24C(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=32,
                   pre_blocks=[4, 4, 4], pos_blocks=[2, 2, 2], k_neighbors=[32, 32, 32],
                   reducers=[4, 2, 2], **kwargs)


def model24D(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=32,
                   pre_blocks=[4, 4, 4], pos_blocks=[2, 2, 2], k_neighbors=[20, 20, 20],
                   reducers=[4, 2, 2], **kwargs)


def model24E(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=64,
                   pre_blocks=[4, 4, 4], pos_blocks=[2, 2, 2], k_neighbors=[20, 20, 20],
                   reducers=[4, 2, 2], **kwargs)


def model24F(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=64,
                   pre_blocks=[4, 4, 4], pos_blocks=[2, 2, 2], k_neighbors=[16, 16, 16],
                   reducers=[4, 2, 2], **kwargs)


def model24G(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=64,
