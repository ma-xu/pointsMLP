"""
Based on model24, simplfy the classifier.
...
class Model26(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64,
        ...
        self.classifier = nn.Sequential(
            nn.Linear(last_channel, min(512,last_channel)),
            nn.BatchNorm1d(min(512,last_channel)),
            nn.GELU(),
            nn.Dropout(0.5),
            nn.Linear(min(512,last_channel), 256),
            nn.BatchNorm1d(256),
            nn.GELU(),
            nn.Dropout(0.5),
...
def model26A(num_classes=40, **kwargs) -> Model26:
    return Model26(points=1024, class_num=num_classes, embed_dim=64,
                   pre_blocks=[2, 2, 2], pos_blocks=[2, 2, 2], k_neighbors=[32, 32, 32],
                   reducers=[4, 2, 2], **kwargs)


def model26B(num_classes=40, **kwargs) -> Model26:
    return Model26(points=1024, class_num=num_classes, embed_dim=32,
                   pre_blocks=[2, 2, 2], pos_blocks=[2, 2, 2], k_neighbors=[32, 32, 32],
                   reducers=[4, 2, 2], **kwargs)


def model26C(num_classes=40, **kwargs) -> Model26:
    return Model26(points=1024, class_num=num_classes, embed_dim=32,
                   pre_blocks=[4, 4, 4], pos_blocks=[2, 2, 2], k_neighbors=[32, 32, 32],
                   reducers=[4, 2, 2], **kwargs)


def model26D(num_classes=40, **kwargs) -> Model26:
    return Model26(points=1024, class_num=num_classes, embed_dim=32,
                   pre_blocks=[4, 4, 4], pos_blocks=[2, 2, 2], k_neighbors=[20, 20, 20],
                   reducers=[4, 2, 2], **kwargs)


def model26E(num_classes=40, **kwargs) -> Model26:
    return Model26(points=1024, class_num=num_classes, embed_dim=64,
                   pre_blocks=[4, 4, 4], pos_blocks=[2, 2, 2], k_neighbors=[20, 20, 20],
                   reducers=[4, 2, 2], **kwargs)


def model26F(num_classes=40, **kwargs) -> Model26:
    return Model26(points=1024, class_num=num_classes, embed_dim=64,
                   pre_blocks=[4, 4, 4], pos_blocks=[2, 2, 2], k_neighbors=[16, 16, 16],
                   reducers=[4, 2, 2], **kwargs)


def model26G(num_classes=40, **kwargs) -> Model26:
    return Model26(points=1024, class_num=num_classes, embed_dim=64,
                   pre_blocks=[4, 4], pos_blocks=[4, 4], k_neighbors=[32, 32],
                   reducers=[4, 4], **kwargs)

def model26H(num_classes=40, **kwargs) -> Model26:
    return Model26(points=1024, class_num=num_classes, embed_dim=128,
                   pre_blocks=[4, 4], pos_blocks=[4, 4], k_neighbors=[32, 32],
                   reducers=[4, 4], **kwargs)
