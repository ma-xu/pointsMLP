...
class Attention(nn.Module):
    def __init__(self, dim, heads=8, head_dim=32, similarity="dot", dropout=0.2):
        super().__init__()
...
class Pointsformer1(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64, groups=1, res_expansion=1.0,
                 ...
                 heads = [1,2,4,6], head_dims = [64,64,64,64], similarity="dot",
...
def pointsformer1(num_classes=40, **kwargs) -> Pointsformer1:
...
def pointsformer6(num_classes=40, **kwargs) -> Pointsformer1:
