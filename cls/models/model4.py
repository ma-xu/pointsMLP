"""
Based on model3, remove the positional encoding.
Based on model2, only the dropout in FC also configuable.
...
class Model4(nn.Module):
    ...
    def forward(self, x):  # [b,3,n]
        ...
        for i in range(self.stages):
            ...
            points = self.local_blocks_list[i](grouped_points)  # [b,p,d]
        # global-feature extraction
        # global_position = self.global_positional_embedding(xyz)
        points = self.global_transformers(points)
...
def model4A9(num_classes=40, **kwargs) -> Model4:
    return Model4(points=1024, class_num=num_classes, embed_dim=128, pool="max",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3, dropout=0.1,
                 reducers=[4, 4], **kwargs)


def model4A10(num_classes=40, **kwargs) -> Model4:
    return Model4(points=1024, class_num=num_classes, embed_dim=64, pool="max",
...
def model4A11(num_classes=40, **kwargs) -> Model4:
    return Model4(points=1024, class_num=num_classes, embed_dim=64, pool="max",
...
def model4A12(num_classes=40, **kwargs) -> Model4:
    return Model4(points=1024, class_num=num_classes, embed_dim=64, pool="max",
...
def model4B(num_classes=40, **kwargs) -> Model4:
    return Model4(points=1024, class_num=num_classes, embed_dim=64, pool="mean",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3,
                 reducers=[4, 4], **kwargs)

def model4C(num_classes=40, **kwargs) -> Model4:
    return Model4(points=1024, class_num=num_classes, embed_dim=64, pool="logsumexp",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3,
                 reducers=[4, 4], **kwargs)

def model4D(num_classes=40, **kwargs) -> Model4:
    return Model4(points=1024, class_num=num_classes, embed_dim=128, pool="max",
                 k_neighbors=[32, 32], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3,
                 reducers=[4, 4], **kwargs)

def model4E(num_classes=40, **kwargs) -> Model4:
    return Model4(points=1024, class_num=num_classes, embed_dim=128, pool="max",
                 k_neighbors=[64, 64], expansion=2, groups=8,
                 local_blocks=[2, 2], global_blocks=3,
                 reducers=[4, 4], **kwargs)

def model4F(num_classes=40, **kwargs) -> Model4:
    return Model4(points=1024, class_num=num_classes, embed_dim=128, pool="max",
                 k_neighbors=[32, 32], expansion=2, groups=8,
...
if __name__ == '__main__':
    ...
    print("===> testing model4A1-12")
    for model in [model4A1(),model4A2(),model4A3(),model4A4(),model4A5(),model4A6(),model4A7(),
                  model4A8(),model4A9(),model4A10(),model4A11(),model4A2()]:
        out = model(data)
        print(out.shape)
