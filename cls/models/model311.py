...
def model311A(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[32, 32, 32, 32], reducers=[2, 2, 2, 2], **kwargs)

def model311B(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
...
def model311C(num_classes=40, **kwargs) -> model311: # 85.219, 85.67, 85.115 , 85.566
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)

def model311D(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
def model311E(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=32, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[32, 32, 32, 32], reducers=[2, 2, 2, 2], **kwargs)


def model311F(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=0.125,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[32, 32, 32, 32], reducers=[2, 2, 2, 2], **kwargs)


def model311G(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=16, res_expansion=2.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[32, 32, 32, 32], reducers=[2, 2, 2, 2], **kwargs)
...
def model311Ablation1111(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[1, 1, 1, 1], pos_blocks=[1, 1, 1, 1],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)

def model311Ablation1111NOnorm(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize=None,
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[1, 1, 1, 1], pos_blocks=[1, 1, 1, 1],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)

def model311Ablation3333(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[3, 3, 3, 3], pos_blocks=[3, 3, 3, 3],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)

def model311Ablation3333NOnorm(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize=None,
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[3, 3, 3, 3], pos_blocks=[3, 3, 3, 3],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)

def model311Ablation2222NOnorm(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize=None,
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)
...
def model311AblationNopre(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[0, 0, 0, 0], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)

def model311AblationNopos(num_classes=40, **kwargs) -> model311:
    return model311(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
...
if __name__ == '__main__':
    ...
    print("===> testing model311Ablation1111 ...")
    model = model311Ablation1111()
    out = model(data)
    print(out.shape)

    print("===> testing model311Ablation1111NOnorm ...")
    model = model311Ablation1111NOnorm()
    out = model(data)
    print(out.shape)

    print("===> testing model311Ablation3333 ...")
    model = model311Ablation3333()
    out = model(data)
    print(out.shape)

    print("===> testing model311Ablation3333NOnorm ...")
    model = model311Ablation3333NOnorm()
    out = model(data)
    print(out.shape)

    print("===> testing model311AblationNopre ...")
    model = model311AblationNopre()
    out = model(data)
    print(out.shape)

    print("===> testing model311AblationNopos ...")
    model = model311AblationNopos()
    out = model(data)
    print(out.shape)
