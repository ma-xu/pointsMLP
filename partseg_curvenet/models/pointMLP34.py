...
def model34A(num_classes=50, **kwargs) -> PointMLP34:
...
def model34B(num_classes=50, **kwargs) -> PointMLP34:
    return PointMLP34(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model34C(num_classes=50, **kwargs) -> PointMLP34:
    return PointMLP34(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model34D(num_classes=50, **kwargs) -> PointMLP34:
    return PointMLP34(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[1, 1, 1, 1],
                 k_neighbors=[24, 24, 24, 7], reducers=[4, 4, 4, 4], de_dims=[512, 512, 256, 256],
