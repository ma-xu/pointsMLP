"""
Based on pointMLP32, remove the global max pooling global context part.
Same model as pointMLP31, just different configurations.
...
class PointMLP33(nn.Module):
    def __init__(self, num_classes=50, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Conv1d(cls_dim+de_dims[-1], 128, 1, bias=bias),
            nn.BatchNorm1d(128),
            self.act,
            nn.Dropout(),
    ...
    def forward(self, x, cls_label):
        ...
        x = torch.cat([x, cls_token.repeat([1, 1, x.shape[-1]])], dim=1)
        x = self.classifier(x)
...
def model33A(num_classes=50, **kwargs) -> PointMLP33:
    return PointMLP33(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 ...
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 24, 16, 8], reducers=[4, 4, 4, 4],
                 de_dims=[512, 256, 128, 128], de_blocks=[4,4,4,4],
                 gmp_dim=64,cls_dim=64, **kwargs)


def model33B(num_classes=50, **kwargs) -> PointMLP33:
    return PointMLP33(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
...
def model33C(num_classes=50, **kwargs) -> PointMLP33:
    return PointMLP33(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 24, 16, 8], reducers=[4, 4, 4, 4],
...
def model33D(num_classes=50, **kwargs) -> PointMLP33:
    return PointMLP33(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
...
def model33E(num_classes=50, **kwargs) -> PointMLP33:
    return PointMLP33(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=False, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 24, 16, 8], reducers=[4, 4, 4, 4],
...
def model33F(num_classes=50, **kwargs) -> PointMLP33:
    return PointMLP33(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=1.0,
...
def model33G(num_classes=50, **kwargs) -> PointMLP33:
    return PointMLP33(num_classes=num_classes, points=2048, embed_dim=64, groups=1, res_expansion=0.125,
